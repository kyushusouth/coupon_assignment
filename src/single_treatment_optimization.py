...
def main():
    ...
    for metric in ["cvr_A", "cvr_B", "pur_A", "pur_B"]:
    ...
    for loss_ratio in range(21):
        ...
        assign_solution = solve_cost_minimization_problem(
            segment_df, ml_module.coupon_map, allowed_cv
        )
        ...
        coupon_assign_df["loss_ratio"] = loss_ratio
